        ...
        <div className="flex-shrink-0 sticky top-0 z-10 bg-background">
          <div className="p-6 pb-0 border-b border-border">
            ...
            <div className="pb-4 mt-6">
              ...
              <p className="text-sm mt-1 font-bold text-slate-600">
          ...
          {isAuditor && audit.status !== "Audit Passed" && audit.status !== "Audit Failed" && <div className="p-4 border-b border-border">
              <AuditChecklist auditId={auditId!} initialProgress={checklistProgress} onComplete={(hasFailures, comments) => {
            setChecklistCompleted(true);
          ...
          <ReviewActions auditId={auditId!} currentStatus={audit.status} currentFileName={audit.file_name} nextAuditId={nextAudit?.id} checklistCompleted={checklistCompleted || audit.status === "Audit Passed" || audit.status === "Audit Failed"} hasChecklistFailures={hasChecklistFailures} checklistFailureComments={checklistComments} />
        </div>
