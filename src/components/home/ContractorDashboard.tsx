...
const ContractorDashboard = () => {
  ...
  const checklistContractorScope = { type: 'contractor' as const, contractorId: contractorId || '' };
  const { data: checklistSummary } = useChecklistSummary(checklistPeriod, checklistContractorScope);
