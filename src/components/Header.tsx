  ...
  return <header className="border-b bg-card sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-card/95">
      <div className="container flex items-center justify-between h-14 sm:h-16 px-4 sm:px-6">
        ...
        <nav className="hidden lg:flex items-center gap-4 xl:gap-6">
          ...
          {(userRole === 'auditor' || userRole === 'admin' || userRole === 'super_admin') && <NavLink to="/interviews" className="text-sm font-medium transition-colors hover:text-primary" activeClassName="text-primary">
              Interviews
            </NavLink>}
          ...
          {(userRole === 'data_entry_clerk' || userRole === 'quality_assurance_manager') && <NavLink to="/my-analytics" className="text-sm font-medium transition-colors hover:text-primary" activeClassName="text-primary">
              My Analytics
            </NavLink>}
          ...
          {(userRole === 'admin' || userRole === 'super_admin') && <>
              ...
              {userRole === 'super_admin' ? <NavLink to="/analytics" className="text-sm font-medium transition-colors hover:text-primary" activeClassName="text-primary">
                  Analytics
                </NavLink> : <NavLink to="/my-analytics" className="text-sm font-medium transition-colors hover:text-primary" activeClassName="text-primary">
                  My Analytics
                </NavLink>}
        ...
        <div className="flex items-center gap-2">
          {isAuditor && activeContractorId && <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1 bg-primary/10 border border-primary/20 rounded-md">
