...
export const PageBoundaryChart = ({
  ...
  const boundaries = [24, 50, 76, 102, 128, 154, 180, 206, 232, 258];
  
  // Count hits for each boundary
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">
                Actual Rate (Expected: {expectedBoundaryRate}%)
              </div>
            </div>
          </div>
          ...
          {(neverHitsBoundaries || alwaysHitsBoundaries) && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                {alwaysHitsBoundaries && (
                  <div>
                    <strong>CRITICAL:</strong> Agent consistently ends interviews at exact page boundaries. 
                    This is statistically impossible and indicates data fabrication.
                  </div>
                )}
                {neverHitsBoundaries && (
                  <div>
                    <strong>WARNING:</strong> Agent never hits page boundaries across {totalInterviews} interviews.
                    This suggests deliberate avoidance and possible awareness of monitoring.
                  </div>
                )}
              </AlertDescription>
            </Alert>
